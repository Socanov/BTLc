...
namespace BTLc.Tiles.Bars
{
	public class NightIngot : ModTile
	{
		...
		public override bool Drop(int i, int j) {
			...
			if (style == 0) {
				Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 16, ModContent.ItemType<Items.Materials.NightIngot>());
			}
